...
## Current State (Phase 1, server scaffold + Notes + search)
...
No MCP surface, no embeddings/hybrid search, no Pages yet — see the architecture plan's "Implementation sequencing" section for what's next.
