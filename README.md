...
![Tack Platform — Backend Architecture](docs/tack-architecture.svg)

*(Source: [`docs/tack-architecture.svg`](docs/tack-architecture.svg) — a single self-contained SVG, safe to drop directly into a slide deck or export to PNG; regenerate/edit by hand, no build step or diagramming tool required.)*
